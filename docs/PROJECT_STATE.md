...
- 修复代码 HEAD `3e24aca7561273752dd65d719e54c86ce0c0843f` 的 FACM Windows Build #705 成功，Mayhem Source Probe #44 也成功。
- 当前下一门槛：用最新测试包做真实 Windows **连续两次启动**验收。第一次新 bundle 允许发生一次后台释放；第二次必须明显命中快速缓存。两次都要确认动作缓存阶段实际显示“正在编译着色器…”和可见进度条。
