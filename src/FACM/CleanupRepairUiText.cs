namespace FACM
{
    internal static class CleanupRepairUiText
    {
        ...
        public const string WindowTitle = "GGman · 清理与修复";
        ...
        public const string NeedAdmin = "环境清理需要管理员权限。GGman 将以管理员身份重新启动并继续清理。";
        public const string ElevationFailed = "未能启动管理员模式，请手动右键 GGman.exe，选择“以管理员身份运行”。";
        ...
        public const string Facm = "GGman";
    }
}
