...
namespace FACM.League
{
    internal static class LeagueProfileCustomizationUiTextKeys
    {
        ...
        public const string TokensTitle = "LeagueProfileCustomizationTokensTitle";
        public const string TokensHint = "LeagueProfileCustomizationTokensHint";
        public const string TokensAction = "LeagueProfileCustomizationTokensAction";
        public const string TokensApplied = "LeagueProfileCustomizationTokensApplied";
        public const string TokensOverridden = "LeagueProfileCustomizationTokensOverridden";
    ...
    internal static class LeagueProfileCustomizationText
    {
        ...
        {
            { LeagueProfileCustomizationUiTextKeys.WindowTitle, "GGman · 召唤师外观" },
            ...
            { LeagueProfileCustomizationUiTextKeys.Overridden, "客户端已恢复其它背景；GGman 没有继续强制覆盖" },
            ...
            { LeagueProfileCustomizationUiTextKeys.RegaliaOverridden, "客户端已恢复其它边框状态；GGman 没有继续强制覆盖" },
            ...
            { LeagueProfileCustomizationUiTextKeys.BannerHint, "切换为上赛季旗帜。GGman 会先读取当前挑战偏好，保留其它资料字段，再写入并有限读回确认。" },
            { LeagueProfileCustomizationUiTextKeys.BannerAction, "切换旗帜" },
            { LeagueProfileCustomizationUiTextKeys.BannerApplied, "赛季旗帜已读回确认" },
            { LeagueProfileCustomizationUiTextKeys.BannerOverridden, "客户端已恢复其它旗帜状态；GGman 没有继续强制覆盖" },
            { LeagueProfileCustomizationUiTextKeys.BannerUnverified, "客户端接受了旗帜修改，但暂时无法读回确认" },
            { LeagueProfileCustomizationUiTextKeys.BannerUnavailable, "未读取到足够的当前挑战偏好，未执行旗帜修改" },
            { LeagueProfileCustomizationUiTextKeys.BannerWriteFailed, "客户端拒绝或未完成这次旗帜修改" },
            { LeagueProfileCustomizationUiTextKeys.TokensTitle, "挑战徽章" },
            { LeagueProfileCustomizationUiTextKeys.TokensHint, "清空当前展示的挑战徽章。GGman 会保留标题、旗帜和边框等其它挑战资料字段，只写入一次并有限读回确认。" },
            { LeagueProfileCustomizationUiTextKeys.TokensAction, "清除徽章" },
            { LeagueProfileCustomizationUiTextKeys.TokensApplied, "挑战徽章已清空并读回确认" },
            { LeagueProfileCustomizationUiTextKeys.TokensOverridden, "客户端已恢复挑战徽章或其它资料状态；GGman 没有继续强制覆盖" },
            ...
            { LeagueProfileCustomizationUiTextKeys.EmotesHint, "清空账号范围的表情槽位。GGman 只在能唯一确认完整账号配置时执行一次 PATCH，并进行有限读回确认。" },
            { LeagueProfileCustomizationUiTextKeys.EmotesAction, "清空表情" },
            { LeagueProfileCustomizationUiTextKeys.EmotesApplied, "表情槽位已清空并读回确认" },
            { LeagueProfileCustomizationUiTextKeys.EmotesOverridden, "客户端已恢复一个或多个表情槽位；GGman 没有继续强制覆盖" },
