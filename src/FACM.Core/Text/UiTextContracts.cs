...
public static class FoundationUiTextDefaults
{
    private static readonly IReadOnlyDictionary<string, string> Values = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        [UiTextKeys.DesktopOpenShell] = "打开 GGman 控制中心",
        [UiTextKeys.DesktopOpenShellHelp] = "打开或激活 GGman 主窗口。",

        [UiTextKeys.CleanupDirectoryTitle] = "游戏目录",
        [UiTextKeys.CleanupDirectoryDescription] = "先确认英雄联盟安装目录。GGman 只会按内置白名单生成清理预览。",
        ...
        [UiTextKeys.CleanupSafetyHint] = "GGman 不会结束进程、停止服务或删除白名单之外的文件。",
        ...
        [UiTextKeys.RepairToolsDescription] = "沿用已验证的修复行为；旧 Fix-LCU 外部模式不会在 4.0 重新启用。",
        ...
        [UiTextKeys.RepairSkipSettlementHint] = "通过 GGman 当前客户端连接跳过卡住、持续转圈的结算页面。",
        ...
        [UiTextKeys.RepairGameRepairReady] = "准备就绪 · 游戏修复已由 GGman 原生接管",
        ...
        [UiTextKeys.LeagueAutoAcceptHint] = "进入等待接受后只尝试一次；若你已接受或拒绝，GGman 不会覆盖你的选择。",
